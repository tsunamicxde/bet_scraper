...
class LolUpcomingScraper:
    ...
    def setup_method(self):
        ...
        self.vars = {}
        self.cursor.execute('''CREATE TABLE IF NOT EXISTS lol (
    ...
    def scrape(self):
        ...
        time.sleep(6)
        self.driver.find_element(By.CSS_SELECTOR, ".game-item:nth-child(4)").click()
        ...
        while True:
            ...
            while index < len(match_cards):
                try:
                    ...
                    try:
                        self.driver.find_element(By.LINK_TEXT, "Map2").click()
                    except NoSuchElementException:
                        is_r2_available = False

                    time.sleep(2)
                    try:
                        self.driver.find_element(By.LINK_TEXT, "Map3").click()
                    except NoSuchElementException:
                    ...
                    try:
                        ...
                        for row in results:
                            ...
                            title = f"{left_team_name} vs {right_team_name} League of Legends (RAYBET)\n\n"
                            message = title
                    ...
                    try:
                        ...
                        self.cursor.execute(''' 
                                                INSERT INTO lol (left_team_name, right_team_name, common, r1, r2, r3)
                                                SELECT ?, ?, ?, ?, ?, ?
                                                WHERE NOT EXISTS (
                                                    SELECT 1 FROM lol
                                                    WHERE left_team_name = ? AND right_team_name = ?
