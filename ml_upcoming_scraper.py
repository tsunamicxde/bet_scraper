...
class MlUpcomingScraper:
    ...
    def setup_method(self):
        ...
        self.vars = {}
        self.cursor.execute('''CREATE TABLE IF NOT EXISTS ml (
    ...
    def scrape(self):
        ...
        time.sleep(6)
        self.driver.find_element(By.CSS_SELECTOR, ".game-item:nth-child(8)").click()
                ...
                try:
                    ...
                    try:
                        ...
                        for row in results:
                            ...
                            title = f"{left_team_name} vs {right_team_name} Mobile Legends (RAYBET)\n\n"
                            message = title
                    ...
                    try:
                        ...
                        self.cursor.execute(''' 
                                                INSERT INTO ml (left_team_name, right_team_name, common, r1, r2, r3)
                                                SELECT ?, ?, ?, ?, ?, ?
                                                WHERE NOT EXISTS (
                                                    SELECT 1 FROM ml
                                                    WHERE left_team_name = ? AND right_team_name = ?
